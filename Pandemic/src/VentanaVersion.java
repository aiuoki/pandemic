...
/**
 * 
 * Esta es la clase de la ventana version
 * @author aiuoki
 *
 */
public class VentanaVersion extends JFrame implements ActionListener {
	...
	public VentanaVersion() {
        ...
        JLabel titulo = new JLabel("Versión"); // TEXTO
        ...
        panelSecundario.setPreferredSize(new Dimension(400, 120)); // TAMAÑO DEL PANEL
        ...
        JLabel version = new JLabel("1.0"); // TEXTO
        version.setForeground(new Color(255, 255, 255)); // COLOR FUENTE
        version.setFont(new Font("Arial", Font.PLAIN, 30)); // FUENTE Y TAMAÑO DE LA FUENTE
        panelSecundario.add(version); // LO AÑADIMOS AL PANEL SECUNDARIO
